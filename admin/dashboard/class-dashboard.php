...
class Dashboard {
	...
	private function dependencies() {
        ...
        require MG_PATH . 'admin/dashboard/class-dashboard-widget.php';

        // Get the welcome panel class.
        require MG_PATH . 'admin/dashboard/class-welcome.php';
    ...
    public function metaboxes() {
        ...
        || ( class_exists( 'acf' ) && class_exists( 'acf_options_page' ) ) ) {
            ...
            $hide = get_field( 'mg_dashboard_hide_widgets', 'option' );
        ...
        // If Advanced Custom Fields is not active.
            ...
            // Get options.
            $welcome    = get_option( 'mg_hide_welcome' );
            $gutenberg  = get_option( 'mg_hide_try_gutenberg' );
            $wp_news    = get_option( 'mg_hide_wp_news' );
            $quickpress = get_option( 'mg_hide_quickpress' );
            $at_glance  = get_option( 'mg_hide_at_glance' );
            $activity   = get_option( 'mg_hide_activity' );
    ...
    public function add_help() {
		...
		$screen->add_help_tab( [
			...
			'title'    => __( 'Welcome Panel', 'motor-grit' ),
			'content'  => null,
		...
		$screen->add_help_tab( [
			...
			'title'    => __( 'Dashboard Widgets', 'motor-grit' ),
			'content'  => null,
	...
	public function help_welcome_panel() {
        ...
        include_once MG_PATH . 'partials/help/help-welcome-panel.php';
	...
	public function help_dashboard_widgets() {
        ...
        include_once MG_PATH . 'partials/help/help-dashboard-widgets.php';
    ...
    public function help_dashboard_sidebar() {
        ...
        $html  = sprintf(
            '<h4>%1s %2s</h4>',
            __( 'Custom Dashboard for', 'motor-grit' ),
             get_bloginfo( 'name' )
        );
	...
	public function styles() {
        ...
        if ( $screen->id == 'dashboard' ) {
            wp_enqueue_style( MG_ADMIN_SLUG . '-dashboard', MG_URL .  'assets/css/dashboard.min.css', [], null, 'screen' );
        }
