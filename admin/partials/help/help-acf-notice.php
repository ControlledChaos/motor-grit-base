...
<div>
	<h3><?php _e( 'Advanced Custom Fields Notice', 'motor-grit' ); ?></h3>
	<?php echo sprintf(
		...
		esc_html__( 'The tabs and the settings on this page are reproduced by different code within this plugin when the', 'motor-grit' ),
		esc_html__( 'plugin is installed and activated. Specifically it needs to be the', 'motor-grit' ),
		esc_url( 'https://www.advancedcustomfields.com/pro' ),
		esc_html__( 'Pro edition', 'motor-grit' ),
		esc_html__( 'of the plugin or the', 'motor-grit' ),
		esc_url( 'https://wordpress.org/plugins/advanced-custom-fields/' ),
		esc_html__( 'free version', 'motor-grit' ),
		esc_html__( 'plus the', 'motor-grit' ),
		esc_url( 'https://www.advancedcustomfields.com/add-ons/options-page/' ),
		esc_html__( 'Options Page addon.', 'motor-grit' )
	); ?>
	...
	<p><?php _e( 'This plugin comes equipped with an ACF fields import tool that will import the ACF fields registered by this plugin so that they can be modified.', 'motor-grit' ); ?></p>
</div>