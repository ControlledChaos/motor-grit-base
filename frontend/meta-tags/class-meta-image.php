...
class Meta_Image {
	...
	public function __construct() {
		...
		add_action( 'mg_meta_image_tag', [ $this, 'image' ] );
	...
	public function image() {
		...
		if ( class_exists( 'acf_pro' ) || ( class_exists( 'acf' ) && class_exists( 'acf_options_page' ) ) ) {
			...
			$blog_image    = get_field( 'mg_meta_blog_image', 'option' );
			$default_image = get_field( 'mg_meta_default_image', 'option' );
